...
Rectangle {
    ...
    Ship {
        ...
        visible: placeMode && mouse_area1.containsMouse
        type: placeShipType
    ...
    Rectangle {
        ...
        color: "#4637fd00"
        visible: selectionMode && (shootType == 1) && mouse_area1.containsMouse
        x: selectionPosX
        y: selectionPosY
    }
    Shoot2 {
        ...
        visible: selectionMode && (shootType == 2) && mouse_area1.containsMouse
    ...
    Rectangle {
        ...
        height: main.cellHeight
        color: "#4637fd00"
        visible: selectionMode && (shootType == 3) && mouse_area1.containsMouse
        x: selectionPosX-main.cellWidth
        y: selectionPosY
    }
    Rectangle {
        ...
        height: main.cellHeight*3
        color: "#4637fd00"
        visible: selectionMode && (shootType == 4) && mouse_area1.containsMouse
        x: selectionPosX
        y: selectionPosY-main.cellHeight
    }
