...
class MATRIX( object ):    
    def __init__( self, height = 10, width = 10 ):
        self.Height = height
        self.Width = width
        self.mut_array_player1 = [[0 for height in range( 10 )] for width in range( 10 )]
        self.mut_array_player2 = [[0 for height in range( 10 )] for width in range( 10 )]
